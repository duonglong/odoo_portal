...
export default function LeaveRequestScreen() {
    ...
    // Inclusive calendar-day count between the two date strings (YYYY-MM-DD parsed as UTC)
                                ...
                                <View className="flex-col gap-6">
                                    ...
                                    <View className="flex-row items-center gap-3 p-4 rounded-xl bg-primary-50 border border-primary-200">
                                        ...
                                        <Text className="text-sm text-slate-700 flex-1">
                                            You are requesting <Text className="font-bold text-primary-600">{dayCount} {dayCount === 1 ? 'day' : 'days'}</Text> off.
                                        </Text>
                                    </View>
