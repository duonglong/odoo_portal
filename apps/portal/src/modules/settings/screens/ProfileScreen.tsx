...
import { type UpdateProfileData } from '../repository.js';
...
export default function ProfileScreen() {
    ...
    const { data: states } = useStates(formData?.countryId ?? undefined);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            toast.error('Update failed', e instanceof Error ? e.message : 'Failed to update profile');
        }
    };
    ...
    const handleChangePassword = async () => {
        ...
        try {
            ...
            toast.error('Password change failed', e instanceof Error ? e.message : 'Could not change password.');
        }
    };
    ...
    const handlePickImage = async () => {
        ...
        try {
            ...
            toast.error('Upload failed', e instanceof Error ? e.message : 'Failed to upload profile picture');
        }
    };
