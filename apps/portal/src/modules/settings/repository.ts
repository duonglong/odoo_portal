...
export class SettingsRepository {
    ...
    async updateProfile(userId: number, partnerId: number, data: UpdateProfileData): Promise<boolean> {
        ...
        if (data.countryId !== undefined) partnerUpdates['country_id'] = data.countryId ?? false;
        if (data.stateId !== undefined) partnerUpdates['state_id'] = data.stateId ?? false;
